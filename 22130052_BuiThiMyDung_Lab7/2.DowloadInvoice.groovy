...
WebUI.setText(findTestObject('Object Repository/Page_Automation Exercise - Payment/input_Name on Card_name_on_card'), 'dung')

WebUI.setText(findTestObject('Object Repository/Page_Automation Exercise - Payment/input_Card Number_card_number'), '1234')

WebUI.click(findTestObject('Object Repository/Page_Automation Exercise - Payment/button_Pay and Confirm Order'))

WebUI.setText(findTestObject('Object Repository/Page_Automation Exercise - Payment/input_CVC_cvc'), '123')

WebUI.setText(findTestObject('Object Repository/Page_Automation Exercise - Payment/input_Expiration_expiry_month'), '12')

WebUI.setText(findTestObject('Object Repository/Page_Automation Exercise - Payment/input_Expiration_expiry_year'), '2004')

WebUI.click(findTestObject('Object Repository/Page_Automation Exercise - Payment/button_Pay and Confirm Order'))

WebUI.click(findTestObject('Object Repository/Page_Automation Exercise - Order Placed/a_Download Invoice'))

WebUI.click(findTestObject('Object Repository/Page_Automation Exercise - Order Placed/a_Continue'))
WebUI.closeBrowser()
